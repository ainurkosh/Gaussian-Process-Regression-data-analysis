...
av_param1 = sum(param1) / length(param1) * ones(size(param1));
...
av_param2 = sum(param2) / length(param2)* ones(size(param2));
...
av_param3 = sum(param3) / length(param3)* ones(size(param3));
...
av_param4 = sum(param4) / length(param4)* ones(size(param4));
...
av_param = sum(param) / length(param)* ones(size(param));
...
av_paramr = sum(paramr) / length(paramr);


% mean value of the ratio as a function of G%
G_ratio = [0.1 20 40 60 100];
all_av_param = [av_param1(1) av_param2(1) av_param3(1) av_param4(1) av_param(1) ]; 
...
plot(param1, 'sb', 'LineWidth', 3)
hold on
plot(av_param1,'r--', 'LineWidth', 2)
hold off
...
plot(param2, 'sb', 'LineWidth', 3)
%ylabel('param ratio (f/S) @ max(G)');
hold on
plot(av_param2,'r--', 'LineWidth', 2)
hold off
...
plot(param3, 'sb', 'LineWidth', 3)
hold on
plot(av_param3,'r--', 'LineWidth', 2)
hold off
...
plot(param4, 'sb', 'LineWidth', 3)
hold on
plot(av_param4,'r--', 'LineWidth', 2)
hold off
...
plot(param, 'sb', 'LineWidth', 3)
hold on
plot(av_param,'r--', 'LineWidth', 2)
hold off
...
% figure
% plot(G_ratio, all_av_param, 'sk', 'LineWidth', 2)
% xlabel('% of maxG')
% grid on
% set(gca,'XMinorTick','on','YMinorTick','on')
% set(gca,'FontSize',letter)
